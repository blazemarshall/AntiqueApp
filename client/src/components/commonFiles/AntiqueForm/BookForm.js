...
export default function BookForm({submitHandler,initialFields,form,setForm,editBool,changeHandler,categoryValue}){
    ...
    <div className="inputList-labels-list" >
     {editBool && <p className="inputList-label">Id: </p>  }
      ...
      <p className="inputList-label">Genre: </p>  
    ...
    <div className="inputList-inputs-list" >
        ...
        <input id="category"        name="category"       type="text" placeholder="Category"          className="inputList-input" onChange={changeHandler} value={categoryValue}        maxLength="50"    aria-label="category input box" />
        ...
        <input id="genre"           name="genre"          type="text" placeholder="Genre"             className="inputList-input" onChange={changeHandler} value={form.genre}         maxLength="50"    aria-label="genre input box" />
        ...
        <input id="type"            name="type"           type="text" placeholder="Type"              className="inputList-input" onChange={changeHandler} value={form.type}            maxLength="50"    aria-label="type input box" />
